                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MusicRow("assets/images/cover2.jpg", "Warrior",
                            "Oscar & The Wolf"),
                        MusicRow("assets/images/cover3.jpg", "Cymatics",
                            "Nigel Stanford"),
                        MusicRow("assets/images/cover4.jpg", "Burning Sun",
                            "Monolink"),
                        MusicRow(
                            "assets/images/cover5.jpg", "Radio Open", "Adele"),
                        MusicRow("assets/images/cover6.jpg", "Turk Marsi",
                            "Bethoven"),
                        MusicRow(
                            "assets/images/cover7.jpg", "Ask", "Muslum Baba"),
                        MusicRow("assets/images/cover8.jpg", "Warrior",
                            "Oscar & The Wolf"),
                        SizedBox(height: 20),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          child: Row(
                            children: [
                              ...
                              MusicRow2("assets/images/cover2.jpg", "Warrior",
                                  "Oscar & The Wolf"),
                              MusicRow2("assets/images/cover3.jpg", "Cymatics",
                                  "Nigel Stanford"),
                              ...
                              MusicRow2("assets/images/cover6.jpg",
                                  "Turk Marsi", "Bethoven"),
                              MusicRow2("assets/images/cover7.jpg", "Ask",
                                  "Muslum Baba"),
                              MusicRow2("assets/images/cover8.jpg", "Warrior",
                                  "Oscar & The Wolf"),
                            ],
                          ),
                        ),
